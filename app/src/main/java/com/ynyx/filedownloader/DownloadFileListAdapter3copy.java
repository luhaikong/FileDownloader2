...
public class DownloadFileListAdapter3copy extends RecyclerView.Adapter<DownloadFileListAdapter3copy.FileViewHolder>
        implements OnRetryableFileDownloadStatusListener {

    private static final String TAG = DownloadFileListAdapter3copy.class.getSimpleName();
    // all download infos
    ...
    public DownloadFileListAdapter3copy(Context context) {
    ...
    public void onBindViewHolder(FileViewHolder holder, int position) {
        ...
        if (downloadFileInfo != null) {
            ...
            if (cacheConvertView == null) {
                cacheConvertView = View.inflate(context, R.layout.main__item_download, null);
